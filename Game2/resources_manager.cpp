...
void ResourcesManager::load() {
	...
	try {
		...
		load_audio(_T(R"(resources\audio\throw_barbs.mp3)"), _T("throw_barbs"));
		load_audio(_T(R"(resources\audio\throw_silk.mp3)"), _T("throw_silk"));
		load_audio(_T(R"(resources\audio\throw_sword.mp3)"), _T("throw_sword"));
